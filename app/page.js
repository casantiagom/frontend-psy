              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-5xl">
                    Mental Health Cristobal
                  </h1>
                  <p className="mt-4 text-lg text-gray-300">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Curabitur pretium ex ornare lacus venenatis, a ornare massa
                    interdum. Pellentesque consectetur ultricies dui a
                    tincidunt.
                  </p>
                </div>
              </div>
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Curabitur pretium ex ornare lacus venenatis, a ornare
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Lorem ipsum</h6>
                    <p className="mt-2 mb-4 text-gray-600">
                      onsectetur adipiscing elit. Curabitur pretium ex ornare
                      lacus venenatis, a ornare
                    </p>
                  </div>
                </div>
              </div>
